...
!a.buttonCancel&&!a.fixedWindow&&d.click(g);d.fadeTo(a.duration,0.5);b("body").append(c);popup=b("#"+a.cssId);popup.fadeOut(0);f=popup.find("#"+a.cssId+"_content");if(null!==a.url&&""!==a.url)f.html('<img src="'+a.loaderUrl+'">'),popup.width(32),h(),popup.fadeIn(a.duration),b.ajax({url:a.url,cache:!1,type:"GET",success:function(b){f.html(b);i();popup.width(a.width);centerPopup();if(null!==a.onLoad)a.onLoad(e)},error:function(b,c,d){f.html(a.url+": "+d);i();popup.width(a.width);h();if(null!==a.onError)a.onError(e)}});
