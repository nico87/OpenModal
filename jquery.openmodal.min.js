...
!a.buttonCancel&&!a.locked&&d.click(g);d.fadeTo(a.duration,0.5);b("body").append(c);popup=b("#"+a.cssId);popup.fadeOut(0);f=popup.find("#"+a.cssId+"_content");if(null!==a.url&&""!==a.url)f.html('<img src="'+a.loaderUrl+'">'),popup.width(32),h(),popup.fadeIn(a.duration),b.ajax({url:a.url,cache:!1,type:"GET",success:function(b){f.html(b);i();popup.width(a.width);centerPopup();if(null!==a.onLoad)a.onLoad(e)},error:function(b,c,d){f.html(a.url+": "+d);i();popup.width(a.width);h();if(null!==a.onError)a.onError(e)}});
else if(null!==a.html&&""!==a.html){if(f.html(a.html),i(),popup.width(a.width),h(),popup.fadeIn(a.duration),null!==a.onLoad)a.onLoad(e)}else null!==a.img&&""!==a.img&&(popup.css("position","fixed"),f.html('<img src="'+a.loaderUrl+'">'),i(),popup.width(32),h(),popup.fadeIn(a.duration),c=b("<img>"),c.load(function(){b(this).unbind("load");f.empty().append(b(this));b(this).css("margin",0);var c=b(this).width(),d=b(this).height();c>b(window).width()-80&&(d=d*(b(window).width()-80)/c,c=b(window).width()-
80);d>b(window).height()-80&&(c=c*(b(window).height()-80)/d,d=b(window).height()-80);popup.width(c).height(d+popup.find("#"+a.cssId+"_buttons").outerHeight());b(this).width(c).height(d);h();if(null!==a.onLoad)a.onLoad(e)}),c.attr("src",a.img));a.buttonOk&&popup.find("#"+a.cssId+"_buttonok").click(function(){null!==a.onSuccess?!1!==a.onSuccess(e)&&g():g();return!1});a.buttonCancel&&popup.find("#"+a.cssId+"_buttoncancel").click(function(){null!==a.onCancel?!1!==a.onCancel(e)&&g():g();return!1});return this}})(jQuery);
